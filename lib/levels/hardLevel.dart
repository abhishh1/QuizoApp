              ...
              child: ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text(
                        'Finals! Hurray! This is it man. Now answer these tough ones and be the winner.Hey its a hard one,Dont forget to swap new questions.And yes,Swapping here in less than 3.Victory is always sweet.GO for it :)',
      ...
      itemBuilder: (context, index) => Card(
        ...
        child: ExpansionTile(
          ...
          children: results[index].allAnswers.map((m) {
            return AnswerWidget(results, index, m, swap);
          }).toList(),
        ),
      ),
    );
